...
<body>
    ...
    <div class="card-body col-md-4 mx-auto mv-auto" style="background-color: #FAF6F6; margin-top : 20vh; border-radius:20px; box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.2);">
        <center>
        <center>
            <h5 class="text-primary mb-3" style="padding-top: 2rem ;">Masuk Sebagai Penjual</h5>
        </center>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            ...
            <center>
                <button id="noedit" type="submit" class="btn btn-primary " name="login">Masuk</button>
            </center>
            <center style="padding-bottom: 2rem; margin :auto;">
                <small class="pull-right pb-5"> Belum Punya Akun? <a href="register.php">Daftar</a></small>
            </center>
        </form>
    </div>
    <script>
