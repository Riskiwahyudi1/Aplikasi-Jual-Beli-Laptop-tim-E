    ...
    <div class="row no-gutters mt-0 h-100">
        <div class="col-md-2 mt-2 pr-3 pt-4 " style="background-color:#749BC2;">
            <ul class="nav flex-column ml-3 mb-5 ">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href=""><i class="fas fa-box me-2"></i>Data Produk</a>
                    <hr class="bg-secondary">
                </li>
                <li class="nav-item ">
        ...
        <div class="col-md-10 p-5 pt-2">
            <center>
                <h4><i class="fas mt-5"></i> Data Pejualan Barang</h4>
                                    ...
                                    <form action="simpan_produk.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group mb-2">
                                            <input type="number" class="form-control" id="id_barang" name="id_barang"
                                                value="<?php echo $data1['id_barang']; ?>">
                                        </div>
                                        <div class="form-group mb-2">
                                            <input type="text" class="form-control" id="nama_barang" name="nama_barang"
                                                value="<?php echo $data1['nama_barang']; ?>">
                                        </div>
                                        <div class="form-group mb-2">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <h6 style="color :red;" align="center">Apakah anda yakin ingin menghapus ID
                                        <?php echo $data['id_barang'];?><strong><span class="grt"></span></strong> Nama
                                ...
                                <div class="modal-body">
                                    <form action="simpan_produk.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group mb-2">
                                            ...
                                            <textarea class="form-control" id="deskripsi_barang" name="deskripsi_barang"
                                        ...
                                        <div class="modal-footer mb-2">
                                            <button id="nosave" type="button" class="btn btn-danger pull-left"
                                                data-dismiss="modal">Batal</button>
                                            <input type="submit" name="proses_simpan" class="btn btn-primary"
                                                value="Simpan">
                                        </div>
                                    </form>
                                </div>
