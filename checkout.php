        ...
        <div class="container-fluid">
            ...
            <div class="col d-flex justify-content-end">
                ...
                <a href="" style="text-decoration: none;">
                    <small class="me-5 mt text-dark"><b>
                            <?php echo $user; ?>
                        </b></small>
                </a>
            ...
            <div class="container-fluid" style="margin-top:50px; ">
                ...
                <div class="row">
                    <div class="col-md-3 mt-1 mb-3 me-1">
                        <b>Penjual : <span id="getNamaPenjual">
                                <?php echo $data['username_penjual']; ?>
                            </span></b>
                    </div>
                </div>
                <div class="row">
                ...
                <div class=" row" style="border-bottom: solid 1px black;">
                    <div class="col-md-1 " style="margin-left:50px;">
                        <img src="file/<?php echo $data['foto_barang']; ?>" alt="" class="w-75 h-75 me-2">
                    ...
                    <div class="col-md-3 ">
                        <p style="color: #FF7F09;">Rp.<span class="harga" data-harga="10" id="getHargaBarang">
                ...
                <?php
                include 'koneksi.php';
                $result = mysqli_query($koneksi, "SELECT * FROM login_pembeli ");
                $dataAlamat = mysqli_fetch_array($result)
                    ?>
                <div class=" row" style="border-bottom: solid 1px black;">
                    <div class="col-md-4 me-5" style="margin-left:50px;">
                        <p id="getAlamat">
                            <?php echo $dataAlamat['alamat']; ?>
                        </p>
                    </div>
                    <div class=" col-md-2 ">
                        <a href="#" data-toggle="modal" data-target="#editalamat<?php echo $dataAlamat['username']; ?>"
                ...
                <div class="row">
                    <div class="col-md-11 mt-3 mb-3 d-flex justify-content-end " style="color:#FF7F09;">
                        <p class="me-5" id="gettotalTransaksi">Rp.<span class="total">
                                <?php echo $data['harga_barang']; ?>
                            </span></p>
